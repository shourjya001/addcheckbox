function saveCurrency() {
    ...
    if ($sub_group_code!= '') {
        if ($creditfile_type == '26' && $cod_withlimit == '1') {
            ...
            $query_Line = "SELECT * FROM dbo.\"SPU_TSPMCURDBE\"('".$sub_group_code."', '".$Scurr."', ".$txtrate.", '".$codUsr."', '".$lastComment."', '".$CF_Level."', ".$creditfile_type.", false)";
            ...
            $query_Line = "SELECT * FROM dbo.\"SPU_TSPMCURDBE\"('".$sub_group_code."', '".$Scurr."', ".$txtrate.", '".$codUsr."', '".$lastComment."', '".$CF_Level."', ".$creditfile_type.", true)";
            $result_Line = pg_query($query_Line);
